...
#> 
#> $`set-cookie`
#> [1] "JSESSIONID=C9418A5C49CB99ED026C9074A9B22B40; Path=/; HttpOnly"
#> 
...
#> 
#> $date
#> [1] "Tue, 10 Mar 2015 14:48:41 GMT"
#> 
#> $connection
#> [1] "close"
#> 
...
#> Error in detail_memento("http://cnn.com", "2001-09-11"): Objekt 'date_time' nicht gefunden
```
